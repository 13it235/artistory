...
class App_Home extends Component {
    ...
    componentWillMount() {
        var login_url = authUrl + 'client_id=' + clientId + '&response_type=token&redirect_uri='+ redirectURi + '&scope=' + scopes.join("%20") + '&state=34fFs29kd09'
...
export default connect(mapStateToProps, null)(App_Home);
